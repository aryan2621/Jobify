...
function AuthCallbackContent() {
    ...
    useEffect(() => {
        ...
        if (code) {
            if (window.opener) {
                window.opener.postMessage({ type: 'oauth_response', code, state }, window.location.origin);
    ...
    return (<div className='flex min-h-screen flex-col items-center justify-center p-4 bg-muted/30'>
            ...
            : error
                ...
                <CardContent className='pt-6 pb-4'>
                    {code ? (<div className='text-center space-y-4'>
                        ...
                        </div>) : error ? (<div className='text-center space-y-4'>
...
export default function AuthCallbackPage() {
    return (<Suspense fallback={<div className='flex min-h-screen flex-col items-center justify-center p-4 bg-muted/30'>
