...
import AiDialog from '@/elements/ai-dialog';
    ...
    const handleOptionChange = (value: NotificationOption) => {
        ...
        setNewNode({
            ...
            data: {
                ...newNode.data,
                emailConfig:
                    value === NotificationOption.EMAIL ? newNode.data.emailConfig || { to: '', cc: '', bcc: '', subject: '', body: '' } : undefined,
                messageConfig:
                    value === NotificationOption.SMS || value === NotificationOption.WHATSAPP
                        ? newNode.data.messageConfig || { phoneNumber: '', body: '' }
                        : undefined,
            },
        });
    };
