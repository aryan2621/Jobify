                            ...
                            <div className='flex flex-col justify-center space-y-4'>
                                <div className='space-y-2'>
                                    ...
                                    <p className='max-w-[600px] text-muted-foreground md:text-xl'>
                                        Discover the best job opportunities in
                                        your field and take the next step in
                                        your career.
                                    </p>
                                </div>
                        ...
                        <div className='flex flex-col items-center justify-center space-y-4 text-center'>
                            <div className='space-y-2'>
                                ...
                                <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                                    Browse through our curated list of the best
                            ...
                            <div className='grid w-full max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3'>
                                <Card>
                                    ...
                                    <CardContent>
                                        <p className='text-muted-foreground'>
                                            Seeking a talented software engineer
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <p className='text-muted-foreground'>
                                            ...
                                            needed to lead our digital marketing
                                            initiatives. Strong analytical and
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <p className='text-muted-foreground'>
                                            Seeking a talented product designer
                                            to join our innovative team.
                                            Experience with Figma and
                        ...
                        <div className='flex flex-col items-center justify-center space-y-4 text-center'>
                            <div className='space-y-1'>
                                <h2 className='text-3xl font-bold tracking-tighter sm:text-5xl text-white'>
                                    Discover the Power of Our Job Board
                                </h2>
                                <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                                    Our job board is designed to connect top
                                    talent with leading companies across
                                    industries. With advanced search and
                                    filtering capabilities, you can easily find
                                    the perfect candidates for your open
                                    positions.
                                </p>
                            </div>
                            <div className='grid w-full max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3'>
                                {[
                                    {
                                        ...
                                        description:
                                            'Easily find the best candidates with our advanced search and filtering tools.',
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            'Our job board is trusted by leading companies across industries.',
                                    },
                                ].map((feature, index) => (
                                    <div
                                        key={index}
                                        className='bg-slate-900 text-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300'
                                    >
                                        <div className='space-y-2'>
                    ...
                    <div className='container px-4 md:px-6'>
                        <div className='flex flex-col items-center justify-center space-y-4 text-center'>
                            <div className='space-y-2'>
                                ...
                                <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                                    Our job board is trusted by leading
                                    companies across industries. Post your job
                                    and connect with top talent today.
                                </p>
                            </div>
                        ...
                        <div className='flex flex-col items-center justify-center space-y-4 text-center mb-12'>
                            <div className='space-y-2'>
                                ...
                                <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-gray-300'>
                                    Hear from our satisfied users about their
                                    experience with our job board.
                                </p>
                            </div>
                        </div>
