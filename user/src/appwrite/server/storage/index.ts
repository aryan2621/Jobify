...
/** File extensions allowed in resume-bucket (PDFs + images for avatars). If bucket already exists with only pdf, add image types in Appwrite Console or create a new bucket. */
...
/** Avatar fileId must be ≤36 chars and only [a-zA-Z0-9._-]. Use prefix + hash to stay within limit and avoid collision with resume UUIDs. */
