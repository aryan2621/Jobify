...
function createApplicationCollection() {
    database
        ...
        return Promise.all([
            ...
            database.createEnumAttribute(DB_NAME, APPLICATION_COLLECTION, 'source', [JobSource.LINKEDIN, JobSource.ANGEL_LIST, JobSource.REFERRAL, JobSource.JOB_PORTAL, JobSource.COMPANY_WEBSITE, JobSource.OTHER], true),
            ...
            database.createEnumAttribute(DB_NAME, APPLICATION_COLLECTION, 'status', [ApplicationStatus.APPLIED, ApplicationStatus.SELECTED, ApplicationStatus.REJECTED], true),
...
export { createApplicationCollection, createApplicationDocument, fetchApplicationsByJobId, fetchApplicationById, updateApplicationStatus, fetchApplicationsByUserId, hasApplicationByUserAndJob, };
