...
function createJobCollection() {
    database
        ...
        return Promise.all([
            ...
            database.createEnumAttribute(DB_NAME, JOB_COLLECTION, 'type', [JobType.FULL_TIME, JobType.PART_TIME, JobType.INTERNSHIP, JobType.CONTRACT, JobType.FREELANCE, JobType.TEMPORARY], true),
            database.createEnumAttribute(DB_NAME, JOB_COLLECTION, 'workplaceType', [WorkplaceTypes.REMOTE, WorkplaceTypes.HYBRID, WorkplaceTypes.ONSITE], true),
...
export { createJobCollection, createJobDocument, fetchJobById, fetchAllJobs, fetchJobsByUserId, setApplicationIdToJob, deleteJobDocument };
