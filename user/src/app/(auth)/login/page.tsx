...
export default function LoginPage() {
    ...
    return (<div className='min-h-screen bg-background flex items-center justify-center py-10 px-4'>
                            ...
                            <div className='space-y-3'>
                                <div>
                                    ...
                                    <div className='relative mt-1.5'>
                                        <Input id='username' placeholder='Enter your username' value={req.username} onChange={(e) => setReq({ ...req, username: e.target.value })} className='bg-background' autoComplete='username' autoFocus/>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className='relative mt-1.5'>
                                        <Input id='password' autoComplete='current-password' type={showPassword ? 'text' : 'password'} placeholder='Enter your password' value={req.password} onChange={(e) => setReq({ ...req, password: e.target.value })} className='pr-10 bg-background'/>
