                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input placeholder="https://github.com/username/project" className="pl-9 h-11 border-muted hover:border-primary/50 transition-colors focus:ring-primary/20" value={submissionData.repoLink} onChange={(e) => setSubmissionData(prev => ({ ...prev, repoLink: e.target.value }))}/>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea placeholder="Add any specific instructions or notes for the reviewer..." className="min-h-[120px] resize-none border-muted hover:border-primary/50 transition-colors focus:ring-primary/20 p-4" value={submissionData.comments} onChange={(e) => setSubmissionData(prev => ({ ...prev, comments: e.target.value }))}/>
                                </div>
