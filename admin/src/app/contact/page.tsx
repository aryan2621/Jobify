                                    ...
                                    <CardContent>
                                        <Accordion type='single' collapsible className='w-full'>
                                            ...
                                            <AccordionItem value='item-5'>
                                                ...
                                                <AccordionContent>
                                                    <div className='space-y-3 text-muted-foreground'>
                                                        <p>On the login page, click <strong>Forgot password?</strong>, enter your recruiter account email, and submit. Use the link in the email to set a new password. The link expires after 24 hours.</p>
                                                    </div>
                                                </AccordionContent>
                                            </AccordionItem>
